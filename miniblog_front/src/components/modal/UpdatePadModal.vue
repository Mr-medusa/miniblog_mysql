<template>
    <div class="content">
        ...
        <div class="checkbox-pad-default" v-if="defaultOpt  && defaultOpt.isFolder">
            <label for="checkbox-pad-default">default:</label>
            <input id="checkbox-pad-default" type="checkbox" v-model="result.isDefault">
        </div>
    </div>
</template>
...
<script>
    export default {
        ...
        mounted(){
            if(this.defaultOpt && this.defaultOpt.isFolder)
                this.result.isDefault = this.defaultOpt.isDefault;
