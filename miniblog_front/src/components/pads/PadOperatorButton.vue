    ...
    <div class="pads-secondary-nav" v-bind:style="{zIndex:isShowCompleted}">
        ...
        <transition>
            <div class="operator-btn type-area" v-show="isShow">
                <!--add pad-->
                <div vue-authorized class="add-pad hvr-wobble-horizontal" @click="$emit('addPad')" title="new pad"><span>+</span></div>
                <div class="btn-group">
                    <button vue-authorized class="btn hvr-wobble-top" v-bind:class="{selectAllCss:selectState}" @click="operatorAll">批量操作</button>
                    <button vue-authorized class="btn" v-bind:class="{'hvr-wobble-top':selectState,'disabled-btn':!selectState}" :disabled="!selectState" @click="selectAllOfBoxes()">全选</button>
                    <button class="btn hvr-wobble-top" @click="clearAll()">清空</button>
                    <button class="btn hvr-wobble-top" @click="refresh()">刷新</button>
                    <button vue-authorized class="btn" @click="moveTo()" v-bind:class="{'hvr-wobble-top':selectState,'disabled-btn':!selectState}" :disabled="!selectState">移动到</button>
                    <button vue-authorized class="btn delete-btn" @click="deleteAll" v-bind:class="{'hvr-wobble-top':selectState,'disabled-btn':!selectState}" :disabled="!selectState">删除</button>
